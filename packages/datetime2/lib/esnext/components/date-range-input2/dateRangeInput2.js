...
export class DateRangeInput2 extends AbstractPureComponent2 {
    static defaultProps = {
    ...
    static displayName = `${DISPLAYNAME_PREFIX}.DateRangeInput2`;
    ...
    ({ isOpen, ...targetProps }) => {
        return (React.createElement("div", { ...targetProps, className: classNames(CoreClasses.CONTROL_GROUP, targetProps.className) },
