...
import { AbstractPureComponent2, Boundary, Classes as CoreClasses, DISPLAYNAME_PREFIX, InputGroup, Intent, Keys, refHandler, setRef, Utils, } from "@blueprintjs/core";
import { DatePickerUtils, DateRangePicker, } from "@blueprintjs/datetime";
...
var DateRangeInput2 = /** @class */ (function (_super) {
    ...
    function DateRangeInput2(props) {
        ...
        function (_a) {
            ...
            return (React.createElement("div", __assign({}, targetProps, { className: classNames(CoreClasses.CONTROL_GROUP, targetProps.className) }),
                _this.renderInputGroup(Boundary.START),
                _this.renderInputGroup(Boundary.END)));
        };
        _this.renderInputGroup = function (boundary) {
            ...
            return (React.createElement(InputGroup, __assign({ autoComplete: "off", disabled: (_a = inputProps === null || inputProps === void 0 ? void 0 : inputProps.disabled) !== null && _a !== void 0 ? _a : _this.props.disabled }, inputProps, { intent: _this.isInputInErrorState(boundary) ? Intent.DANGER : inputProps === null || inputProps === void 0 ? void 0 : inputProps.intent, inputRef: _this.getInputRef(boundary), onBlur: handleInputEvent, onChange: handleInputEvent, onClick: handleInputEvent, onFocus: handleInputEvent, onKeyDown: handleInputEvent, onMouseDown: handleInputEvent, placeholder: _this.getInputPlaceholderString(boundary), value: _this.getInputDisplayString(boundary) })));
        };
        ...
        _this.handleInputFocus = function (_e, boundary) {
            ...
            var inputString = DatePickerUtils.getFormattedDateString(values.selectedValue, _this.props, true);
        ...
        _this.handleInputBlur = function (_e, boundary) {
            ...
            if (_this.isInputEmpty(values.inputString)) {
                if (isValueControlled) {
                    nextState = __assign(__assign({}, nextState), (_b = {}, _b[keys.inputString] = DatePickerUtils.getFormattedDateString(values.controlledValue, _this.props), _b));
                }
                else {
        ...
        _this.getInputDisplayString = function (boundary) {
            ...
            if (hoverString != null) {
                ...
                return DatePickerUtils.getFormattedDateString(selectedValue, _this.props);
            }
        };
        ...
        _this.isDateValidAndInRange = function (date) {
            ...
            return isValid(date) && isDayInRange(date, [_this.props.minDate, _this.props.maxDate]);
        };
        _this.reset(props);
        return _this;
    }
    ...
    DateRangeInput2.displayName = "".concat(DISPLAYNAME_PREFIX, ".DateRangeInput2");
    return DateRangeInput2;
}(AbstractPureComponent2));
export { DateRangeInput2 };
