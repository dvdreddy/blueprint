...
export var DateInput2 = React.memo(function _DateInput2(props) {
    var _a, _b, _c, _d, _e;
    ...
    _g = props.maxDate, 
    // defaults duplicated here for TypeScript convenience
    maxDate = _g === void 0 ? DEFAULT_MAX_DATE : _g, _h = props.minDate, minDate = _h === void 0 ? DEFAULT_MIN_DATE : _h, placeholder = props.placeholder, _j = props.popoverProps, popoverProps = _j === void 0 ? {} : _j, showTimezoneSelect = props.showTimezoneSelect, timePrecision = props.timePrecision, value = props.value, datePickerProps = __rest(props, ["defaultTimezone", "defaultValue", "disableTimezoneSelect", "fill", "inputProps", "maxDate", "minDate", "placeholder", "popoverProps", "showTimezoneSelect", "timePrecision", "value"]);
    // Refs
    // ------------------------------------------------------------------------
    ...
    var _l = React.useState(defaultTimezone !== null && defaultTimezone !== void 0 ? defaultTimezone : getCurrentTimezone()), timezoneValue = _l[0], setTimezoneValue = _l[1];
    ...
    var handleDateChange = React.useCallback(function (newDate, isUserChange, didSubmitWithEnter) {
        ...
        if (isControlled) {
            ...
            var newFormattedDateString = DatePickerUtils.getFormattedDateString(newDate, props);
            setIsInputFocused(newIsInputFocused);
            setIsOpen(newIsOpen);
            setValue(newDate);
    ...
    var maybeTimezonePicker = isTimezoneSelectHidden ? undefined : (React.createElement(TimezoneSelect, { value: timezoneValue, onChange: handleTimezoneChange, date: tzSelectDate, disabled: isTimezoneSelectDisabled, className: Classes.DATE_INPUT_TIMEZONE_SELECT, buttonProps: timezoneSelectButtonProps },
    ...
    function (_a) {
        var _b, _c, _d;
        var _defaultValue = _a.defaultValue, targetIsOpen = _a.isOpen, ref = _a.ref, targetProps = __rest(_a, ["defaultValue", "isOpen", "ref"]);
        return (React.createElement(InputGroup, __assign({ autoComplete: "off", className: classNames(targetProps.className, inputProps.className), intent: shouldShowErrorStyling && isErrorState ? "danger" : "none", placeholder: placeholder, rightElement: React.createElement(React.Fragment, null,
                maybeTimezonePicker,
                props.rightElement), type: "text" }, targetProps, inputProps, { "aria-expanded": targetIsOpen, disabled: props.disabled, fill: fill, inputRef: mergeRefs(ref, inputRef, (_c = (_b = props.inputProps) === null || _b === void 0 ? void 0 : _b.inputRef) !== null && _c !== void 0 ? _c : null), onBlur: handleInputBlur, onChange: handleInputChange, onClick: handleInputClick, onFocus: handleInputFocus, onKeyDown: handleInputKeyDown, value: (_d = (isInputFocused ? inputValue : formattedDateString)) !== null && _d !== void 0 ? _d : "" })));
    }, [
        fill,
        formattedDateString,
        inputValue,
    ...
    return (React.createElement(Popover2, __assign({ isOpen: isOpen && !props.disabled }, popoverProps, { autoFocus: false, className: classNames(Classes.DATE_INPUT, popoverProps.className, props.className), content: popoverContent, enforceFocus: false, onClose: handlePopoverClose, popoverClassName: classNames(Classes.DATE_INPUT_POPOVER, popoverProps.popoverClassName), renderTarget: renderTarget })));
});
DateInput2.displayName = "".concat(DISPLAYNAME_PREFIX, ".DateInput2");
