...
exports.DateRangeInput2 = void 0;
...
var DateRangeInput2 = /** @class */ (function (_super) {
    tslib_1.__extends(DateRangeInput2, _super);
    function DateRangeInput2(props) {
        var _this = this;
        var _a, _b;
        ...
        function (_a) {
            ...
            return (React.createElement("div", tslib_1.__assign({}, targetProps, { className: (0, classnames_1.default)(core_1.Classes.CONTROL_GROUP, targetProps.className) }),
                _this.renderInputGroup(core_1.Boundary.START),
                _this.renderInputGroup(core_1.Boundary.END)));
        };
        _this.renderInputGroup = function (boundary) {
            ...
            return (React.createElement(core_1.InputGroup, tslib_1.__assign({ autoComplete: "off", disabled: (_a = inputProps === null || inputProps === void 0 ? void 0 : inputProps.disabled) !== null && _a !== void 0 ? _a : _this.props.disabled }, inputProps, { intent: _this.isInputInErrorState(boundary) ? core_1.Intent.DANGER : inputProps === null || inputProps === void 0 ? void 0 : inputProps.intent, inputRef: _this.getInputRef(boundary), onBlur: handleInputEvent, onChange: handleInputEvent, onClick: handleInputEvent, onFocus: handleInputEvent, onKeyDown: handleInputEvent, onMouseDown: handleInputEvent, placeholder: _this.getInputPlaceholderString(boundary), value: _this.getInputDisplayString(boundary) })));
        };
        ...
        _this.handleInputFocus = function (_e, boundary) {
            ...
            var inputString = datetime_1.DatePickerUtils.getFormattedDateString(values.selectedValue, _this.props, true);
        ...
        _this.handleInputBlur = function (_e, boundary) {
            ...
            if (_this.isInputEmpty(values.inputString)) {
                if (isValueControlled) {
                    nextState = tslib_1.__assign(tslib_1.__assign({}, nextState), (_b = {}, _b[keys.inputString] = datetime_1.DatePickerUtils.getFormattedDateString(values.controlledValue, _this.props), _b));
                }
                else {
        ...
        _this.getIsOpenValueWhenDateChanges = function (nextSelectedStart, nextSelectedEnd) {
            if (_this.props.closeOnSelection) {
                ...
                if ((0, dateUtils_1.isSameTime)(selectedStart, nextSelectedStart) && (0, dateUtils_1.isSameTime)(selectedEnd, nextSelectedEnd)) {
                    return false;
                }
                return true;
            }
        ...
        _this.getInputDisplayString = function (boundary) {
            ...
            if (hoverString != null) {
                ...
                return datetime_1.DatePickerUtils.getFormattedDateString(selectedValue, _this.props);
            }
        };
        ...
        _this.isDateValidAndInRange = function (date) {
            ...
            return (0, date_fns_1.isValid)(date) && (0, dateUtils_1.isDayInRange)(date, [_this.props.minDate, _this.props.maxDate]);
        };
        _this.reset(props);
        return _this;
    }
     ...
     */
    DateRangeInput2.prototype.reset = function (props) {
    ...
    // Helpers
    // =======
    DateRangeInput2.prototype.shouldFocusInputRef = function (isFocused, inputRef) {
        return isFocused && inputRef != null && core_1.Utils.getActiveElement(this.startInputElement) !== inputRef;
    };
    DateRangeInput2.prototype.isNextDateRangeValid = function (nextDate, boundary) {
    ...
    DateRangeInput2.prototype.getFormattedMinMaxDateString = function (props, propName) {
        var date = props[propName];
        var defaultDate = DateRangeInput2.defaultProps[propName];
        // default values are applied only if a prop is strictly `undefined`
        // See: https://facebook.github.io/react/docs/react-component.html#defaultprops
        return datetime_1.DatePickerUtils.getFormattedDateString(date === undefined ? defaultDate : date, this.props);
    };
    DateRangeInput2.prototype.parseDate = function (dateString) {
    ...
    DateRangeInput2.prototype.formatDate = function (date) {
    ...
    DateRangeInput2.displayName = "".concat(core_1.DISPLAYNAME_PREFIX, ".DateRangeInput2");
    return DateRangeInput2;
}(core_1.AbstractPureComponent2));
exports.DateRangeInput2 = DateRangeInput2;
//# sourceMappingURL=dateRangeInput2.js.map