...
import { AbstractPureComponent2, Boundary, InputGroupProps2, Props } from "@blueprintjs/core";
import { DateFormatProps, DatePickerBaseProps, DateRangeShortcut } from "@blueprintjs/datetime";
...
export declare class DateRangeInput2 extends AbstractPureComponent2<DateRangeInput2Props, DateRangeInput2State> {
    static defaultProps: Partial<DateRangeInput2Props>;
    ...
    constructor(props: DateRangeInput2Props);
    /**
     * Public method intended for unit testing only. Do not use in feature work!
     */
    reset(props?: DateRangeInput2Props): void;
    componentDidUpdate(prevProps: DateRangeInput2Props, prevState: DateRangeInput2State): void;
    render(): JSX.Element;
    protected validateProps(props: DateRangeInput2Props): void;
