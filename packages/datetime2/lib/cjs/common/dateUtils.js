...
exports.isDayInRange = exports.isSameTime = exports.isDateValid = exports.clone = void 0;
...
function isDayInRange(date, dateRange, exclusive) {
    ...
    return (0, date_fns_1.isWithinInterval)(date, { start: start, end: end }) && (!exclusive || (!(0, date_fns_1.isSameDay)(start, day) && !(0, date_fns_1.isSameDay)(day, end)));
}
