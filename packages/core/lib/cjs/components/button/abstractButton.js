...
var AbstractButton = /** @class */ (function (_super) {
    ...
    AbstractButton.prototype.renderChildren = function () {
        var _a = this.props, children = _a.children, icon = _a.icon, loading = _a.loading, rightIcon = _a.rightIcon, text = _a.text, large = _a.large;
        var maybeHasText = !common_1.Utils.isReactNodeEmpty(text) || !common_1.Utils.isReactNodeEmpty(children);
        return [
            ...
            React.createElement(icon_1.Icon, { key: "leftIcon", icon: icon, iconSize: large ? icon_1.IconSize.LARGE : icon_1.IconSize.STANDARD, "aria-hidden": maybeHasText, tabIndex: maybeHasText ? -1 : undefined }),
