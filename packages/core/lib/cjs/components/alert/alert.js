    ...
    Alert.prototype.render = function () {
        ...
        return (React.createElement(dialog_1.Dialog, tslib_1.__assign({}, overlayProps, { className: (0, classnames_1.default)(common_1.Classes.ALERT, className), canEscapeKeyClose: canEscapeKeyCancel, canOutsideClickClose: canOutsideClickCancel, onClose: this.handleCancel, portalContainer: this.props.portalContainer }),
            React.createElement("div", { className: common_1.Classes.ALERT_BODY },
                React.createElement(icon_1.Icon, { icon: icon, size: 32, intent: intent }),
            ...
            React.createElement("div", { className: common_1.Classes.ALERT_FOOTER },
                React.createElement(buttons_1.Button, { loading: loading, intent: intent, text: confirmButtonText, small: true, onClick: this.handleConfirm }),
                cancelButtonText && (React.createElement(buttons_1.Button, { text: cancelButtonText, disabled: loading, small: true, onClick: this.handleCancel })))));
    };
