...
var Toast = /** @class */ (function (_super) {
    ...
    Toast.prototype.render = function () {
        ...
        return (React.createElement("div", { className: (0, classnames_1.default)(common_1.Classes.TOAST, common_1.Classes.intentClass(intent), className), onBlur: this.startTimeout, onFocus: this.clearTimeouts, onMouseEnter: this.clearTimeouts, onMouseLeave: this.startTimeout, tabIndex: 0 },
            ...
            React.createElement(buttonGroup_1.ButtonGroup, { minimal: true },
                ...
                isCloseButtonShown && React.createElement(buttons_1.Button, { "aria-label": "Close", icon: "cross", small: true, intent: intent, onClick: this.handleCloseClick }))));
    };
    ...
    Toast.prototype.maybeRenderActionButton = function () {
        var _a = this.props, action = _a.action, intent = _a.intent;
        if (action == null) {
            return undefined;
        }
        else {
            return React.createElement(buttons_1.AnchorButton, tslib_1.__assign({}, action, { intent: intent, small: true, onClick: this.handleActionClick }));
        }
    };
