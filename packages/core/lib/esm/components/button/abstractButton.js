...
var AbstractButton = /** @class */ (function (_super) {
    ...
    AbstractButton.prototype.renderChildren = function () {
        ...
        return [
            ...
            React.createElement(Icon, { key: "leftIcon", icon: icon, iconSize: large ? IconSize.LARGE : IconSize.STANDARD, "aria-hidden": maybeHasText, tabIndex: maybeHasText ? -1 : undefined }),
