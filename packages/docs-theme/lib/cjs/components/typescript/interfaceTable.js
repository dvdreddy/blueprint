...
var InterfaceTable = /** @class */ (function (_super) {
    ...
    function InterfaceTable() {
        ...
        _this.renderPropRow = function (entry) {
            ...
            var documentation = ((0, client_1.isTsProperty)(entry) ? entry : entry.signatures[0]).documentation;
            ...
            var typeInfo = (0, client_1.isTsProperty)(entry) ? (React.createElement(React.Fragment, null,
                React.createElement("strong", null, renderType(entry.type)),
                React.createElement("em", { className: (0, classnames_1.default)("docs-prop-default", core_1.Classes.TEXT_MUTED) }, entry.defaultValue))) : (React.createElement(React.Fragment, null,
    ...
    InterfaceTable.prototype.render = function () {
        ...
        var propRows = tslib_1.__spreadArray(tslib_1.__spreadArray([], data.properties, true), data.methods, true).sort(function (a, b) { return a.name.localeCompare(b.name); })
