...
exports.handleNumberChange = exports.handleValueChange = exports.handleStringChange = exports.handleBooleanChange = exports.BaseExample = exports.WARNING_BASE_EXAMPLE_DEPRECATED = void 0;
...
var BaseExample = /** @class */ (function (_super) {
    ...
    BaseExample.prototype.render = function () {
        ...
        return (React.createElement("div", { className: (0, classnames_1.default)("docs-example-frame", this.className), "data-example-id": this.props.id },
