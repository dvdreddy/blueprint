...
var Navigator = /** @class */ (function (_super) {
    ...
    function Navigator() {
        ...
        _this.filterMatches = function (query, items) {
            return (0, fuzzaldrin_plus_1.filter)(items, query, {
                key: "route",
        ...
        _this.renderItem = function (section, props) {
            ...
            return (React.createElement(core_1.MenuItem, { active: props.modifiers.active, href: "#".concat(section.route), key: section.route, multiline: true, onClick: props.handleClick, onFocus: props.handleFocus, roleStructure: "listoption", text: text }));
        };
    ...
    Navigator.prototype.componentDidMount = function () {
        var _this = this;
        this.sections = [];
        (0, utils_1.eachLayoutNode)(this.props.items, function (node, parents) {
            var _a, _b;
    ...
    Navigator.prototype.render = function () {
        ...
        return (React.createElement(select_1.Omnibar, { className: "docs-navigator-menu", inputProps: { placeholder: "Search documentation pages and sections..." }, itemListPredicate: this.filterMatches, isOpen: this.props.isOpen, items: this.sections, itemRenderer: this.renderItem, onItemSelect: this.handleItemSelect, onClose: this.props.onClose, resetOnSelect: true }));
    };
    return Navigator;
}(React.PureComponent));
