...
export var NavMenu = function (props) {
    ...
    var menu = props.items.map(function (section) {
        ...
        var itemClasses = classNames("depth-".concat(section.level - props.level - 1), (_a = {
        ...
        return (React.createElement("li", { key: section.route },
            item,
            isPageNode(section) ? React.createElement(NavMenu, __assign({}, props, { level: section.level, items: section.children })) : null));
    });
