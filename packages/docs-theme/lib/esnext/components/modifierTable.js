...
export const ModifierTable = ({ children, descriptionTitle = "Description", emptyMessage, title, }) => (React.createElement("div", { className: classNames("docs-modifiers-table", Classes.RUNNING_TEXT) },
