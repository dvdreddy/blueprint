...
export class Navigator extends React.PureComponent {
    ...
    renderItem = (section, props) => {
        ...
        return (React.createElement(MenuItem, { active: props.modifiers.active, href: `#${section.route}`, key: section.route, multiline: true, onClick: props.handleClick, onFocus: props.handleFocus, roleStructure: "listoption", text: text }));
    };
