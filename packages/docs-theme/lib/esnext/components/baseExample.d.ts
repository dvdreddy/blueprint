 ...
 * @deprecated
 */
export declare class BaseExample<S extends {}> extends React.Component<IBaseExampleProps, S> {
    ...
    shouldComponentUpdate(nextProps: IBaseExampleProps, nextState: S): boolean;
