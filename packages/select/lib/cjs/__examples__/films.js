...
var renderFilm = function (film, props) {
    ...
    return React.createElement(core_1.MenuItem, tslib_1.__assign({}, getFilmItemProps(film, props)));
};
exports.renderFilm = renderFilm;
/**
 * Renders a menu item to create a single film from a given query string.
 */
var renderCreateFilmMenuItem = function (query, active, handleClick) { return (React.createElement(core_1.MenuItem, { icon: "add", text: "Create \"".concat(query, "\""), roleStructure: "listoption", active: active, onClick: handleClick, shouldDismissPopover: false })); };
 ...
 */
var renderCreateFilmsMenuItem = function (query, active, handleClick) { return (React.createElement(core_1.MenuItem, { icon: "add", text: "Create ".concat(printReadableList(query)), roleStructure: "listoption", active: active, onClick: handleClick, shouldDismissPopover: false })); };
