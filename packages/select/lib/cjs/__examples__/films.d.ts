 ...
 */
export declare function getFilmItemProps(film: Film, { handleClick, handleFocus, modifiers, query }: ItemRendererProps): MenuItemProps & React.Attributes & React.HTMLAttributes<HTMLAnchorElement>;
/**
