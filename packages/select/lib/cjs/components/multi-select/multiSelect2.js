...
var MultiSelect2 = /** @class */ (function (_super) {
    tslib_1.__extends(MultiSelect2, _super);
    function MultiSelect2() {
        ...
        _this.handlePopoverInteraction = function (nextOpenState, evt) {
            return _this.requestAnimationFrame(function () {
                var _a, _b;
                var isInputFocused = _this.input === core_1.Utils.getActiveElement(_this.input);
    ...
    MultiSelect2.prototype.render = function () {
        ...
        var _a = this.props, menuProps = _a.menuProps, openOnKeyDown = _a.openOnKeyDown, popoverProps = _a.popoverProps, tagInputProps = _a.tagInputProps, restProps = tslib_1.__rest(_a, ["menuProps", "openOnKeyDown", "popoverProps", "tagInputProps"]);
        return (React.createElement(queryList_1.QueryList, tslib_1.__assign({}, restProps, { menuProps: tslib_1.__assign(tslib_1.__assign({ "aria-label": "selectable options" }, menuProps), { "aria-multiselectable": true, id: this.listboxId }), onItemSelect: this.handleItemSelect, onQueryChange: this.handleQueryChange, ref: this.refHandlers.queryList, renderer: this.renderQueryList })));
    };
...
exports.MultiSelect2 = MultiSelect2;
