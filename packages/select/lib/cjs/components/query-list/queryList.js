...
var QueryList = /** @class */ (function (_super) {
    ...
    QueryList.prototype.wouldCreatedItemMatchSomeExistingItem = function () {
        ...
        return this.state.filteredItems.some(function (item) {
            var newItems = Array.isArray(_this.state.createNewItem)
                ? _this.state.createNewItem
                : [_this.state.createNewItem];
            return newItems.some(function (newItem) { return (0, common_1.executeItemsEqual)(_this.props.itemsEqual, item, newItem); });
        });
    };
