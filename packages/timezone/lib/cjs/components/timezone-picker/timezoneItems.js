...
function getTimezoneItems(date) {
    return moment.tz
        .names()
        .map(function (timezone) { return (0, timezoneMetadata_1.getTimezoneMetadata)(timezone, date); })
        .sort(function (a, b) { return a.offset - b.offset; })
        .map(toTimezoneItem);
}
exports.getTimezoneItems = getTimezoneItems;
/**
 ...
 */
function getInitialTimezoneItems(date, includeLocalTimezone) {
    var populous = getPopulousTimezoneItems(date);
    var local = getLocalTimezoneItem(date);
    return includeLocalTimezone && local !== undefined ? tslib_1.__spreadArray([local], populous, true) : populous;
}
...
exports.getLocalTimezoneItem = getLocalTimezoneItem;
/**
...
function getPopulousTimezoneItems(date) {
    ...
    var timezoneToMetadata = timezones.reduce(function (store, zone) {
        store[zone] = (0, timezoneMetadata_1.getTimezoneMetadata)(zone, date);
        return store;
    }, {});
