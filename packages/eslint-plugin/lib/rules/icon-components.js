...
exports.iconComponentsRule = (0, createRule_1.createRule)({
    ...
    meta: {
        ...
        fixable: "code",
        messages: {
            [exports.OPTION_COMPONENT]: "Replace icon literal with component: {{ component }}",
            [exports.OPTION_LITERAL]: "Replace icon component with literal: {{ literal }}",
        },
        schema: [
            {
    ...
    defaultOptions: [exports.OPTION_COMPONENT],
    create: context => ({
...
function create(context, node) {
    ...
    if (valueNode == null) {
        ...
        context.report({
            ...
            messageId: exports.OPTION_COMPONENT,
            node,
        });
    }
        ...
        if (match != null) {
            ...
            context.report({
                ...
                messageId: exports.OPTION_LITERAL,
                node,
            });
        }
    }
...
//# sourceMappingURL=icon-components.js.map