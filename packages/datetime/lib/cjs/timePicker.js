...
var TimePicker = /** @class */ (function (_super) {
    ...
    function TimePicker(props, context) {
        ...
        _this.timeInputIds = (_a = {},
            _a[timeUnit_1.TimeUnit.HOUR_24] = core_1.Utils.uniqueId(timeUnit_1.TimeUnit.HOUR_24 + "-input"),
            _a[timeUnit_1.TimeUnit.HOUR_12] = core_1.Utils.uniqueId(timeUnit_1.TimeUnit.HOUR_12 + "-input"),
            _a[timeUnit_1.TimeUnit.MINUTE] = core_1.Utils.uniqueId(timeUnit_1.TimeUnit.MINUTE + "-input"),
            _a[timeUnit_1.TimeUnit.SECOND] = core_1.Utils.uniqueId(timeUnit_1.TimeUnit.SECOND + "-input"),
            _a[timeUnit_1.TimeUnit.MS] = core_1.Utils.uniqueId(timeUnit_1.TimeUnit.MS + "-input"),
            _a);
    ...
    TimePicker.prototype.maybeRenderArrowButton = function (isDirectionUp, timeUnit) {
        ...
        var label = "".concat(isDirectionUp ? "Increase" : "Decrease", " ").concat((0, timeUnit_1.getTimeUnitPrintStr)(timeUnit));
        ...
        return (React.createElement("span", { "aria-controls": this.timeInputIds[timeUnit], "aria-label": label, tabIndex: -1, className: classes, onClick: onClick },
            React.createElement(core_1.Icon, { icon: isDirectionUp ? "chevron-up" : "chevron-down", title: label })));
    };
    ...
    TimePicker.prototype.renderInput = function (className, unit, value) {
        ...
        var isValid = (0, timeUnit_1.isTimeUnitValid)(unit, valueNumber);
