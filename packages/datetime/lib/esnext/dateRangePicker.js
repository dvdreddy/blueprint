...
export class DateRangePicker extends AbstractPureComponent2 {
    static defaultProps = {
    ...
    maybeRenderTimePickers(isShowingOneMonth) {
        ...
        if (isShowingOneMonth) {
            return (React.createElement(TimePicker, { precision: timePrecision, ...timePickerProps, onChange: this.handleTimeChangeLeftCalendar, value: this.state.time[0] }));
        }
        else {
