...
export class Table2 extends AbstractComponent2 {
    static displayName = `${DISPLAYNAME_PREFIX}.Table2`;
    static defaultProps = {
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        const didChildrenChange = !compareChildren(React.Children.toArray(this.props.children), this.state.childrenArray);
    ...
    columnHeaderCellRenderer = (columnIndex) => {
        ...
        if (columnProps.name != null) {
            return React.createElement(ColumnHeaderCell2, { ...baseProps });
        }
        else {
            return React.createElement(ColumnHeaderCell2, { ...baseProps, name: Utils.toBase26Alpha(columnIndex) });
        }
    };
    renderColumnHeader = (refHandler, resizeHandler, reorderingHandler, showFrozenColumnsOnly = false) => {
        ...
        const { defaultColumnWidth, enableMultipleSelection, enableGhostCells, enableColumnReordering, enableColumnResizing, enableRowHeader, loadingOptions, maxColumnWidth, minColumnWidth, selectedRegionTransform, } = this.props;
        ...
        const hasHorizontalOverflowOrExactFit = this.locator.hasHorizontalOverflowOrExactFit(enableRowHeader ? this.rowHeaderWidth : 0, viewportRect);
    ...
    renderRowHeader = (refHandler, resizeHandler, reorderingHandler, showFrozenRowsOnly = false) => {
        const { focusedCell, selectedRegions, viewportRect } = this.state;
        const { defaultRowHeight, enableColumnHeader, enableMultipleSelection, enableGhostCells, enableRowReordering, enableRowResizing, loadingOptions, maxRowHeight, minRowHeight, rowHeaderCellRenderer, selectedRegionTransform, } = this.props;
        ...
        return (React.createElement("div", { className: classes, ref: refHandler },
            React.createElement(RowHeader, { defaultRowHeight: defaultRowHeight, enableMultipleSelection: enableMultipleSelection, focusedCell: focusedCell, grid: this.grid, locator: this.locator, isReorderable: enableRowReordering, isResizable: enableRowResizing, loading: hasLoadingOption(loadingOptions, TableLoadingOption.ROW_HEADERS), maxRowHeight: maxRowHeight, minRowHeight: minRowHeight, onFocusedCell: this.handleFocus, onLayoutLock: this.handleLayoutLock, onMount: this.handleHeaderMounted, onResizeGuide: resizeHandler, onReordered: this.handleRowsReordered, onReordering: reorderingHandler, onRowHeightChanged: this.handleRowHeightChanged, onSelection: this.getEnabledSelectionHandler(RegionCardinality.FULL_ROWS), rowHeaderCellRenderer: rowHeaderCellRenderer, selectedRegions: selectedRegions, selectedRegionTransform: selectedRegionTransform, rowIndexStart: rowIndexStart, rowIndexEnd: rowIndexEnd }),
    ...
    renderBody = (quadrantType, showFrozenRowsOnly = false, showFrozenColumnsOnly = false) => {
        ...
        const { enableMultipleSelection, enableColumnHeader, enableGhostCells, enableRowHeader, loadingOptions, bodyContextMenuRenderer, selectedRegionTransform, } = this.props;
        if (this.grid === null || this.locator === undefined || viewportRect === undefined) {
            return undefined;
        }
        ...
        return (React.createElement("div", null,
            React.createElement(TableBody2, { enableMultipleSelection: enableMultipleSelection, cellRenderer: this.bodyCellRenderer, focusedCell: focusedCell, grid: this.grid, loading: hasLoadingOption(loadingOptions, TableLoadingOption.CELLS), locator: this.locator, onCompleteRender: onCompleteRender, onFocusedCell: this.handleFocus, onSelection: this.getEnabledSelectionHandler(RegionCardinality.CELLS), bodyContextMenuRenderer: bodyContextMenuRenderer, renderMode: this.getNormalizedRenderMode(), selectedRegions: selectedRegions, selectedRegionTransform: selectedRegionTransform, viewportRect: viewportRect, columnIndexStart: columnIndexStart, columnIndexEnd: columnIndexEnd, rowIndexStart: rowIndexStart, rowIndexEnd: rowIndexEnd, numFrozenColumns: showFrozenColumnsOnly ? numFrozenColumns : undefined, numFrozenRows: showFrozenRowsOnly ? numFrozenRows : undefined }),
