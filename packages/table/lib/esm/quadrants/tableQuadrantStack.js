...
var TableQuadrantStack = /** @class */ (function (_super) {
    ...
    function TableQuadrantStack(props, context) {
        ...
        _this.handleColumnsReordering = function (oldIndex, newIndex, length) {
            ...
            var quadrantType = guideIndex <= numFrozenColumns ? QuadrantType.TOP_LEFT : QuadrantType.TOP;
        ...
        _this.handleRowsReordering = function (oldIndex, newIndex, length) {
            ...
            var quadrantType = guideIndex <= numFrozenRows ? QuadrantType.TOP_LEFT : QuadrantType.LEFT;
        ...
        _this.maybeSetQuadrantSizes = function (width, height) {
            var leftWidth = Utils.clamp(width, _this.props.enableRowHeader ? Grid.MIN_ROW_HEADER_WIDTH : 0);
            var topHeight = Utils.clamp(height, _this.props.enableColumnHeader ? Grid.MIN_COLUMN_HEADER_HEIGHT : 0);
            _this.maybesSetQuadrantSize(QuadrantType.LEFT, "width", leftWidth);
            _this.maybesSetQuadrantSize(QuadrantType.TOP, "height", topHeight);
            _this.maybesSetQuadrantSize(QuadrantType.TOP_LEFT, "width", leftWidth);
            _this.maybesSetQuadrantSize(QuadrantType.TOP_LEFT, "height", topHeight);
        };
        ...
        _this.maybesSetQuadrantRowHeaderSizes = function (width) {
            var rowHeaderWidth = Utils.clamp(width, _this.props.enableRowHeader ? Grid.MIN_ROW_HEADER_WIDTH : 0);
            _this.maybeSetQuadrantRowHeaderSize(QuadrantType.MAIN, rowHeaderWidth);
            _this.maybeSetQuadrantRowHeaderSize(QuadrantType.TOP, rowHeaderWidth);
            _this.maybeSetQuadrantRowHeaderSize(QuadrantType.LEFT, rowHeaderWidth);
            _this.maybeSetQuadrantRowHeaderSize(QuadrantType.TOP_LEFT, rowHeaderWidth);
        };
        ...
        _this.maybeSetQuadrantMenuElementSizes = function (width, height) {
            var rowHeaderWidth = Utils.clamp(width, _this.props.enableRowHeader ? Grid.MIN_ROW_HEADER_WIDTH : 0);
            _this.maybeSetQuadrantMenuElementSize(QuadrantType.MAIN, rowHeaderWidth, height);
            _this.maybeSetQuadrantMenuElementSize(QuadrantType.TOP, rowHeaderWidth, height);
            _this.maybeSetQuadrantMenuElementSize(QuadrantType.LEFT, rowHeaderWidth, height);
            _this.maybeSetQuadrantMenuElementSize(QuadrantType.TOP_LEFT, rowHeaderWidth, height);
        };
