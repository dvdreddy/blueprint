...
exports.TruncatedFormat2 = void 0;
...
var TruncatedFormat2 = /** @class */ (function (_super) {
    tslib_1.__extends(TruncatedFormat2, _super);
    ...
    TruncatedFormat2.prototype.renderPopover = function () {
        ...
        if (this.state.isPopoverOpen) {
            ...
            return (React.createElement(popover2_1.Popover2, { className: Classes.TABLE_TRUNCATED_POPOVER_TARGET, content: popoverContent, isOpen: true, onClose: this.handlePopoverClose, placement: "bottom", rootBoundary: "document" },
    ...
    TruncatedFormat2.prototype.shouldShowPopover = function (content) {
        ...
        switch (showPopover) {
            case truncatedFormat_1.TruncatedPopoverMode.ALWAYS:
                return true;
            case truncatedFormat_1.TruncatedPopoverMode.NEVER:
                return false;
            case truncatedFormat_1.TruncatedPopoverMode.WHEN_TRUNCATED:
                return detectTruncation
                    ? this.state.isTruncated
                    : truncateLength > 0 && content.length > truncateLength;
            case truncatedFormat_1.TruncatedPopoverMode.WHEN_TRUNCATED_APPROX:
                if (!detectTruncation) {
    ...
    TruncatedFormat2.prototype.setTruncationState = function () {
        if (!this.props.detectTruncation || this.props.showPopover !== truncatedFormat_1.TruncatedPopoverMode.WHEN_TRUNCATED) {
            return;
        }
    ...
    TruncatedFormat2.displayName = "".concat(core_1.DISPLAYNAME_PREFIX, ".TruncatedFormat2");
...
exports.TruncatedFormat2 = TruncatedFormat2;
