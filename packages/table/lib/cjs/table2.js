...
var react_innertext_1 = tslib_1.__importDefault(require("react-innertext"));
...
var table2Utils_1 = require("./table2Utils");
var tableBody2_1 = require("./tableBody2");
...
var Table2 = /** @class */ (function (_super) {
    ...
    function Table2(props, context) {
        ...
        _this.refHandlers = {
            ...
            columnHeader: function (ref) {
                ...
                if (ref != null) {
                    _this.columnHeaderHeight = Math.max(ref.clientHeight, grid_1.Grid.MIN_COLUMN_HEADER_HEIGHT);
                }
            },
        ...
        _this.columnHeaderHeight = grid_1.Grid.MIN_COLUMN_HEADER_HEIGHT;
        _this.rowHeaderWidth = grid_1.Grid.MIN_ROW_HEADER_WIDTH;
        ...
        _this.renderTableContents = function (_a) {
            ...
            var classes = (0, classnames_1.default)(Classes.TABLE_CONTAINER, (_b = {},
                ...
                _b[Classes.TABLE_SELECTION_ENABLED] = (0, table2Utils_1.isSelectionModeEnabled)(_this.props, regions_2.RegionCardinality.CELLS),
        ...
        _this.renderMenu = function (refHandler) {
            var _a;
            var classes = (0, classnames_1.default)(Classes.TABLE_MENU, (_a = {},
                _a[Classes.TABLE_SELECTION_ENABLED] = (0, table2Utils_1.isSelectionModeEnabled)(_this.props, regions_2.RegionCardinality.FULL_TABLE),
                _a));
        ...
        _this.columnHeaderCellRenderer = function (columnIndex) {
            ...
            var id = columnProps.id, cellRenderer = columnProps.cellRenderer, columnHeaderCellRenderer = columnProps.columnHeaderCellRenderer, spreadableProps = tslib_1.__rest(columnProps, ["id", "cellRenderer", "columnHeaderCellRenderer"]);
            var columnLoading = (0, tableUtils_1.hasLoadingOption)(columnProps.loadingOptions, regions_2.ColumnLoadingOption.HEADER) ||
                (0, tableUtils_1.hasLoadingOption)(_this.props.loadingOptions, regions_2.TableLoadingOption.COLUMN_HEADERS);
            ...
            var baseProps = tslib_1.__assign({ enableColumnInteractionBar: _this.props.enableColumnInteractionBar, index: columnIndex, loading: columnLoading }, spreadableProps);
            if (columnProps.name != null) {
                return React.createElement(columnHeaderCell2_1.ColumnHeaderCell2, tslib_1.__assign({}, baseProps));
            }
            else {
                return React.createElement(columnHeaderCell2_1.ColumnHeaderCell2, tslib_1.__assign({}, baseProps, { name: utils_1.Utils.toBase26Alpha(columnIndex) }));
            }
        };
        _this.renderColumnHeader = function (refHandler, resizeHandler, reorderingHandler, showFrozenColumnsOnly) {
            ...
            var classes = (0, classnames_1.default)(Classes.TABLE_COLUMN_HEADERS, (_a = {},
                _a[Classes.TABLE_SELECTION_ENABLED] = (0, table2Utils_1.isSelectionModeEnabled)(_this.props, regions_2.RegionCardinality.FULL_COLUMNS),
                _a));
        ...
        _this.renderRowHeader = function (refHandler, resizeHandler, reorderingHandler, showFrozenRowsOnly) {
            ...
            var classes = (0, classnames_1.default)(Classes.TABLE_ROW_HEADERS, (_a = {},
                _a[Classes.TABLE_SELECTION_ENABLED] = (0, table2Utils_1.isSelectionModeEnabled)(_this.props, regions_2.RegionCardinality.FULL_ROWS),
                _a));
            if (_this.grid === null || _this.locator === undefined || viewportRect === undefined) {
                // if we haven't mounted yet (which we need in order for grid/viewport calculations),
                // we still want to hand a DOM ref over to TableQuadrantStack for later
            ...
            return (React.createElement("div", { className: classes, ref: refHandler },
                React.createElement(rowHeader_1.RowHeader, { defaultRowHeight: defaultRowHeight, enableMultipleSelection: enableMultipleSelection, focusedCell: focusedCell, grid: _this.grid, locator: _this.locator, isReorderable: enableRowReordering, isResizable: enableRowResizing, loading: (0, tableUtils_1.hasLoadingOption)(loadingOptions, regions_2.TableLoadingOption.ROW_HEADERS), maxRowHeight: maxRowHeight, minRowHeight: minRowHeight, onFocusedCell: _this.handleFocus, onLayoutLock: _this.handleLayoutLock, onMount: _this.handleHeaderMounted, onResizeGuide: resizeHandler, onReordered: _this.handleRowsReordered, onReordering: reorderingHandler, onRowHeightChanged: _this.handleRowHeightChanged, onSelection: _this.getEnabledSelectionHandler(regions_2.RegionCardinality.FULL_ROWS), rowHeaderCellRenderer: rowHeaderCellRenderer, selectedRegions: selectedRegions, selectedRegionTransform: selectedRegionTransform, rowIndexStart: rowIndexStart, rowIndexEnd: rowIndexEnd }),
        ...
        _this.bodyCellRenderer = function (rowIndex, columnIndex) {
            ...
            var id = columnProps.id, cellRenderer = columnProps.cellRenderer, columnHeaderCellRenderer = columnProps.columnHeaderCellRenderer, name = columnProps.name, nameRenderer = columnProps.nameRenderer, restColumnProps = tslib_1.__rest(columnProps, ["id", "cellRenderer", "columnHeaderCellRenderer", "name", "nameRenderer"]);
            // HACKHACK: cellRenderer prop has a default value, so we can assert non-null
            var cell = cellRenderer(rowIndex, columnIndex);
            if (cell === undefined) {
                return undefined;
            }
            var inheritedIsLoading = (0, tableUtils_1.hasLoadingOption)(columnProps.loadingOptions, regions_2.ColumnLoadingOption.CELLS) ||
                (0, tableUtils_1.hasLoadingOption)(_this.props.loadingOptions, regions_2.TableLoadingOption.CELLS);
            return React.cloneElement(cell, tslib_1.__assign(tslib_1.__assign({}, restColumnProps), { loading: (_a = cell.props.loading) !== null && _a !== void 0 ? _a : inheritedIsLoading }));
        };
        _this.renderBody = function (quadrantType, showFrozenRowsOnly, showFrozenColumnsOnly) {
            ...
            return (React.createElement("div", null,
                React.createElement(tableBody2_1.TableBody2, { enableMultipleSelection: enableMultipleSelection, cellRenderer: _this.bodyCellRenderer, focusedCell: focusedCell, grid: _this.grid, loading: (0, tableUtils_1.hasLoadingOption)(loadingOptions, regions_2.TableLoadingOption.CELLS), locator: _this.locator, onCompleteRender: onCompleteRender, onFocusedCell: _this.handleFocus, onSelection: _this.getEnabledSelectionHandler(regions_2.RegionCardinality.CELLS), bodyContextMenuRenderer: bodyContextMenuRenderer, renderMode: _this.getNormalizedRenderMode(), selectedRegions: selectedRegions, selectedRegionTransform: selectedRegionTransform, viewportRect: viewportRect, columnIndexStart: columnIndexStart, columnIndexEnd: columnIndexEnd, rowIndexStart: rowIndexStart, rowIndexEnd: rowIndexEnd, numFrozenColumns: showFrozenColumnsOnly ? numFrozenColumns : undefined, numFrozenRows: showFrozenRowsOnly ? numFrozenRows : undefined }),
                _this.maybeRenderRegions(_this.styleBodyRegion, quadrantType)));
        };
        _this.getEnabledSelectionHandler = function (selectionMode) {
            if (!(0, table2Utils_1.isSelectionModeEnabled)(_this.props, selectionMode)) {
        ...
        _this.syncViewportPosition = function (_a) {
            ...
            if (nextScrollLeft !== undefined || nextScrollTop !== undefined) {
                ...
                var nextViewportRect = new rect_1.Rect(nextScrollLeft !== null && nextScrollLeft !== void 0 ? nextScrollLeft : 0, nextScrollTop !== null && nextScrollTop !== void 0 ? nextScrollTop : 0, viewportRect.width, viewportRect.height);
        ...
        _this.hotkeysImpl = new tableHotkeys_1.TableHotkeys(props, _this.state, {
        ...
        _this.hotkeys = (0, table2Utils_1.getHotkeysFromProps)(props, _this.hotkeysImpl);
    ...
    Table2.getDerivedStateFromProps = function (props, state) {
        ...
        var didChildrenChange = !(0, table2Utils_1.compareChildren)(newChildrenArray, state.childrenArray);
        ...
        var newSelectedRegions = selectedRegions !== null && selectedRegions !== void 0 ? selectedRegions : state.selectedRegions.filter(function (region) {
            ...
            return ((0, table2Utils_1.isSelectionModeEnabled)(props, regionCardinality, selectionModes) &&
        ...
        if (!core_1.Utils.deepCompareKeys(state, nextState, Table2.SHALLOW_COMPARE_STATE_KEYS_DENYLIST)) {
            return nextState;
        }
        return null;
    };
    ...
    Table2.prototype.resizeRowsByApproximateHeight = function (getCellText, options) {
        var rowHeights = (0, resizeRows_1.resizeRowsByApproximateHeight)(this.props.numRows, this.state.columnWidths, getCellText, options);
        this.invalidateGrid();
    ...
    Table2.prototype.resizeRowsByTallestCell = function (columnIndices) {
        ...
        var rowHeights = (0, resizeRows_1.resizeRowsByTallestCell)(this.grid, this.state.viewportRect, this.locator, this.state.rowHeights.length, columnIndices);
        this.invalidateGrid();
        this.setState({ rowHeights: rowHeights });
    };
    /**
    ...
    Table2.prototype.shouldComponentUpdate = function (nextProps, nextState) {
        ...
        return (!core_1.Utils.shallowCompareKeys(this.props, nextProps, propKeysDenylist) ||
            ...
            !core_1.Utils.deepCompareKeys(this.props, nextProps, Table2.SHALLOW_COMPARE_PROP_KEYS_DENYLIST) ||
            !core_1.Utils.deepCompareKeys(this.state, nextState, Table2.SHALLOW_COMPARE_STATE_KEYS_DENYLIST));
    };
    Table2.prototype.render = function () {
        return React.createElement(core_1.HotkeysTarget2, { hotkeys: this.hotkeys }, this.renderTableContents);
    };
    /**
    ...
    Table2.prototype.componentDidUpdate = function (prevProps, prevState) {
        ...
        var didChildrenChange = !(0, table2Utils_1.compareChildren)(React.Children.toArray(this.props.children), this.state.childrenArray);
        ...
        var didColumnWidthsChange = !utils_1.Utils.compareSparseArrays((_a = this.props.columnWidths) !== null && _a !== void 0 ? _a : this.state.columnWidths, prevState.columnWidths);
        var didRowHeightsChange = !utils_1.Utils.compareSparseArrays((_b = this.props.rowHeights) !== null && _b !== void 0 ? _b : this.state.rowHeights, prevState.rowHeights);
        ...
        if (shouldInvalidateHotkeys) {
            this.hotkeys = (0, table2Utils_1.getHotkeysFromProps)(this.props, this.hotkeysImpl);
        }
    ...
    Table2.prototype.shouldDisableVerticalScroll = function () {
        ...
        var areRowHeadersLoading = (0, tableUtils_1.hasLoadingOption)(this.props.loadingOptions, regions_2.TableLoadingOption.ROW_HEADERS);
    ...
    Table2.prototype.shouldDisableHorizontalScroll = function () {
        ...
        var areColumnHeadersLoading = (0, tableUtils_1.hasLoadingOption)(this.props.loadingOptions, regions_2.TableLoadingOption.COLUMN_HEADERS);
    ...
    Table2.prototype.validateGrid = function (_a) {
        ...
        if (this.grid == null || columnWidths !== undefined || rowHeights !== undefined) {
            ...
            var gridBleed = Math.max(grid_1.Grid.DEFAULT_BLEED, numFrozenColumns);
            this.grid = new grid_1.Grid(rowHeights !== null && rowHeights !== void 0 ? rowHeights : this.state.rowHeights, columnWidths !== null && columnWidths !== void 0 ? columnWidths : this.state.columnWidths, gridBleed, defaultRowHeight, defaultColumnWidth);
    ...
    Table2.prototype.maybeRenderRegions = function (getRegionStyle, quadrantType) {
        ...
        var regionGroups = regions_2.Regions.joinStyledRegionGroups(this.state.selectedRegions, (_a = this.props.styledRegionGroups) !== null && _a !== void 0 ? _a : [], this.state.focusedCell);
        return regionGroups.map(function (regionGroup, index) {
            ...
            return (React.createElement(regions_1.RegionLayer, { className: (0, classnames_1.default)(regionGroup.className), key: index, regions: regionGroup.regions, regionStyles: regionStyles }));
        });
    };
    ...
    Table2.displayName = "".concat(core_1.DISPLAYNAME_PREFIX, ".Table2");
    Table2.defaultProps = {
        ...
        getCellClipboardData: function (row, col, cellRenderer) {
            return (0, react_innertext_1.default)(cellRenderer(row, col));
        },
        loadingOptions: [],
        maxColumnWidth: 9999,
        maxRowHeight: 9999,
